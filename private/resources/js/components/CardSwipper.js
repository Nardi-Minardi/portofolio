                ...
                "type": "fraction"
                        ...
                        <div className="mb-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <img src={`${baseURL}public/assets/images/logo-prakerja.png`} alt="prakerja" className="img-fluid" height="20" width="20" />
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="mb-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <img src={`${baseURL}public/assets/images/logo-bpptik.jpg`} alt="bpptik" className="img-fluid" height="20" width="20" />
                                </div>
                                <div className="col-md-8">
                                    <h5 >BPPTIK</h5>
                    ...
                    <SwiperSlide>
                        <div className="mb-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <img src={`${baseURL}public/assets/images/logo-dicoding.png`} alt="dicoding" className="img-fluid" height="20" width="20" />
                                </div>
                                <div className="col-md-8">
                                    <h5>Dicoding</h5>
                    ...
                    <SwiperSlide>
                        <div className="mb-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <img src={`${baseURL}public/assets/images/logo-digitaltalent.png`} alt="digital talent" className="img-fluid" height="20" width="20" />
                                </div>
                                <div className="col-md-8">
                    ...
                    <SwiperSlide>
                        <div className="mb-5">
                            <div className="row">
                                <div className="col-md-4">
                                    <img src={`${baseURL}public/assets/images/logo-microsoft.png`} alt="microsoft" className="img-fluid" height="20" width="20" />
                                </div>
                                <div className="col-md-8">
